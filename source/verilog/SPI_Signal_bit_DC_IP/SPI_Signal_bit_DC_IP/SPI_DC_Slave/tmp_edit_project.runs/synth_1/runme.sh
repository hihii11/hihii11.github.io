...
HD_PWD='D:/Vivado/project/SPI_Signal_bit_DC/SPI_Signal_bit_DC_IP/SPI_DC_Slave/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_Signal_bit_DC_slave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_Signal_bit_DC_slave.tcl
